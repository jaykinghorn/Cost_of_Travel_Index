-- ============================================================================
-- ACCOMMODATIONS: County-Level Cost Calculation
-- ============================================================================
-- Purpose: Calculate median accommodation costs at the county level
--
...
-- Outlier Removal: P5/P98 per county
...
-- Calculate P5 and P98 thresholds per county per month for outlier removal
