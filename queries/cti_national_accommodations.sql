-- ============================================================================
-- CTI NATIONAL ACCOMMODATIONS: National-Level Cost Calculation
-- ============================================================================
-- Purpose: Calculate median accommodation costs at the national level
--
...
--            accommodation costs. Using individual transactions with $50
--            minimum filters out ancillary charges while capturing the
--            full range of hotel stay costs.
--
...
WITH accommodation_transactions AS (
  -- Extract all accommodation transactions above minimum threshold (no state grouping)
  SELECT
