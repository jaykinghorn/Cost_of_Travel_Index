-- ============================================================================
-- CTI NATIONAL ATTRACTIONS: National-Level Cost Calculation WITH DAILY CAP
-- ============================================================================
-- Purpose: Calculate median per-visit attraction costs at the national level
...
--
-- Rationale: National aggregation provides a single U.S. baseline for attraction
--            costs. Using individual transactions with daily cap provides a
--            representative sample while preventing high-frequency transactions
...
WITH attraction_transactions_raw AS (
  -- Extract all attraction transactions with daily ranking (no state grouping)
  SELECT
...
-- Track capping impact nationally with visit behavior metrics
capping_impact AS (
  SELECT
    r.month_date,
...
GROUP BY a.month_date, i.txn_before_cap, i.txn_after_cap,
