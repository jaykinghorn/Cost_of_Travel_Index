-- ============================================================================
-- ATTRACTIONS: County-Level Cost Calculation WITH DAILY CAP
-- ============================================================================
-- Purpose: Calculate median per-visit attraction costs at the county level
...
-- Track capping impact per county with visit behavior metrics
capping_impact AS (
  SELECT
    r.merch_county,
    r.merch_state,
...
attractions_no_outliers AS (
  ...
  JOIN county_thresholds t
    ON a.merch_county = t.merch_county
    AND a.merch_state = t.merch_state
...
LEFT JOIN capping_impact i
  ON a.merch_county = i.merch_county
  AND a.merch_state = i.merch_state
  AND a.month_date = i.month_date
GROUP BY a.merch_county, a.merch_state, a.month_date, i.txn_before_cap, i.txn_after_cap,
