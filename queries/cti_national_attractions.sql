-- ============================================================================
-- CTI NATIONAL ATTRACTIONS: National-Level Cost Calculation
-- ============================================================================
...
--            attraction costs, calculated from all visitor transactions
...
WITH attraction_transactions AS (
  -- Extract all attraction transactions for the period (no state grouping)
  SELECT
