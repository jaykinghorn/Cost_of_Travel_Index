-- ============================================================================
-- CTI REGIONAL ATTRACTIONS: Census Division-Level Cost Calculation WITH DAILY CAP
-- ============================================================================
...
--            from inflating the median. Division-level aggregation provides regional
--            pricing trends.
--
...
WITH attraction_transactions_raw AS (
  -- Extract all attraction transactions with daily ranking and division mapping
  SELECT
...
-- Track capping impact per division with visit behavior metrics
capping_impact AS (
  SELECT
    r.census_region_division,
    r.month_date,
...
LEFT JOIN capping_impact i
  ON a.census_region_division = i.census_region_division
  AND a.month_date = i.month_date
GROUP BY a.census_region_division, a.month_date, i.txn_before_cap, i.txn_after_cap,
...
ORDER BY a.month_date, a.census_region_division
